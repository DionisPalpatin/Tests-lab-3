from sql_faker.column import Column
from sql_faker.foreign_key import ForeignKey
from sql_faker.primary_key import PrimaryKey
from sql_faker.functions import check_type, check_value_is_not_less_than
...
class Table:
    ...
    :type db_object: Python generator.sqlfaker_natali Database object
    :type n_rows: Integer
    ...
    def export_dml(self, filename: str):
        """This method returns a table's DML script.

        :returns: DML statement as File
        """
        data = []
        attributes = []
        datatype = []
